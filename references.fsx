...
#r @"C:\Users\Jerry\.nuget\packages\netstandard.library\2.0.3\build\netstandard2.0\ref\netstandard.dll"
#load @"d:\Jerry\Projects\test.fsharp\test.fsharp\divideByBind.fs"
#load @"d:\Jerry\Projects\test.fsharp\test.fsharp\divideByExplicit.fs"
#load @"d:\Jerry\Projects\test.fsharp\test.fsharp\download.fs"
#load @"d:\Jerry\Projects\test.fsharp\test.fsharp\functionList.fs"
#load @"d:\Jerry\Projects\test.fsharp\test.fsharp\mapreduce.fs"
#load @"d:\Jerry\Projects\test.fsharp\test.fsharp\messageIO.fs"
#load @"d:\Jerry\Projects\test.fsharp\test.fsharp\piglatin.fs"
#load @"d:\Jerry\Projects\test.fsharp\test.fsharp\quicksort.fs"
#load @"d:\Jerry\Projects\test.fsharp\test.fsharp\shapes.fs"
#load @"d:\Jerry\Projects\test.fsharp\test.fsharp\strategy.fs"
#load @"d:\Jerry\Projects\test.fsharp\test.fsharp\wordcount.fs"